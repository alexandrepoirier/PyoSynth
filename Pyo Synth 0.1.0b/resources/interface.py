...
class RecordedTracksWindow(wx.Frame):
    ...
    def startRecording(self):
        if 'mix' not in self.script_namespace:
            print "Cannot record because the script does not have a 'mix' object."
            return None
        else:
...
class MenuPanel(wx.Panel):
    def __init__(self, parent, pos, size, namespace):
        ...
        self.btn_save.Bind(buttons.EVT_BTN_CLICKED, self._savePreset)
    ...
    def _savePreset(self, evt):
        self.GetParent().savePreset(self._script_path)
